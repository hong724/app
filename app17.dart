...
String s1='我的名字是鄧彥宏，2004年出生於桃園市，從治平高中電機科畢業後進入高雄科技大學電機工程系。'
'父親的工作是工人，母親則是家庭主婦，家庭經濟小康，氣氛和樂。'
'父母從小讓我養成有責任感與堅持的觀念，家人覺得自身的品格大於一切，要對自己做的事負責且問心無愧，自然而然也灌輸許多正向觀念給我，他們總會尊重我的決定，教我對事要有責任心與毅力。';
String s2='個人特質\n我是一個喜愛手作和發現新事物的人，被電機的實作所深深吸引，加上父親的工作是負責廠務維修，從小就培養出我對電機方面濃厚的興趣，因而選擇走上電機這條路，高中在剛接觸到電路板設計時，那種面對新事物的感覺和解出問題的成就感，讓我非常的享受，高中畢業後考量未來發展配合我有興趣的領域，最終選擇國立高雄科技大學
電機系就讀。';
String s3='未來展望\n未來希望能透過台電獎學金的方式進入到台電工作，以發揮大學及研究所所學為台灣的電力盡一份心力，不管將來遇到任何困難，都會時時提醒自己切勿忘記當初投入電機的初心，努力堅持不懈以實現自己的理想。';
...
image: AssetImage("17.jpg"),fit: BoxFit.cover,)
),
